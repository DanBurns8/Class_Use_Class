...
public class Line {
    ...
    public double distance() {
        double xdis = end1.getX() - end2.getX();
        double ydis = end1.getY() - end2.getY();
        double d = Math.sqrt(Math.pow(xdis, 2) + Math.pow(ydis, 2));
        return d;
    }
    public Point midpoint() {
     double xnum = end1.getX() + end2.getX();
     double ynum = end1.getY() + end2.getY();
     double x = xnum / 2;
     double y = ynum / 2;
